...
function ProductList() {
  ...
  const [searchTerm, setSearchTerm] = useState(''); // For API calls
      ...
      <div className="product-list-header">
        <div className="header-content">
          <div className="header-text">
            <h1 data-text="Browse Items">Browse Items</h1>
            <p>Discover amazing products from fellow students across campus</p>
          </div>
                ...
                {product.images && product.images.length > 0 ? (
                  <>
                    <img
                      ...
                      alt={product.title}
                      style={{ border: '2px solid blue' }} // Temporary to see if img exists
                      onError={(e) => {
                      ...
                      onLoad={(e) => {
                        console.log('Product card image loaded:', product.images[0]);
                        e.target?.parentElement?.querySelector('.image-placeholder')?.style.setProperty('display', 'none');
                      }}
                    />
